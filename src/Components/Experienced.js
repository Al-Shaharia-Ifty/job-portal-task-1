...
const Experienced = () => {
  ...
  fetch("https://jobfinder-server.vercel.app/experiencedJobs")
    .then((res) => res.json())
  ...
  return (
    <div>
      <h2
        data-aos="flip-down"
        className="lg:text-3xl text-2xl font-bold text-center mt-10"
      >
        Experienced Jobs
      </h2>
        ...
        {jobs.map((j) => (
          ...
          >
            ...
            <div className="absolute bottom-4 right-4">
              <Link to={`/experienced/${j.id}`} className="btn bg-orange-600">
                View More
              </Link>
            </div>
          </div>
